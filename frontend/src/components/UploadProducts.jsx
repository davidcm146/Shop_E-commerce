...
const UploadProducts = ({ onClose, calFunc }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const dataResponse = await fetch(summaryURL.uploadProducts.url, {
            method: summaryURL.uploadProducts.method,
            credentials: 'include',
            headers: {
            ...
            <div className="relative p-4 w-full max-w-xl max-h-full">
                <div className="relative bg-white rounded-lg shadow-lg">
                    <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200">
                        <h3 className="text-lg font-semibold text-gray-800">Upload New Product</h3>
                        <button
                            type="button"
                            onClick={onClose}
                    ...
                    <div className="p-4 md:p-5 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 64px)' }}>
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                                ...
                                                {products.productImage.map((item, index) => (
                                                    <div className="relative group" key={index}>
                                                        ...
                                                        <div
                                                            ...
                                                            className="absolute rounded-full bottom-0 right-0 p-1 text-white bg-red-600 cursor-pointer hover:bg-red-400 hidden group-hover:block"
                                                        >
                                                            <MdDelete />
                                                        </div>
                                                    </div>
                                ...
                                <div className="col-span-2">
                                    <label htmlFor="productDescription" className="block mb-2 text-sm font-medium text-gray-800">Description</label>
                                    <textarea
