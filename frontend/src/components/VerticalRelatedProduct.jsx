...
const VerticalRelatedProduct = ({ category, heading, currentProductId }) => {
    ...
    const fetchData = async () => {
        ...
        if (categoryProduct.success) {
            ...
            const filteredData = categoryProduct.data.filter(product => product._id !== currentProductId);
...
export default VerticalRelatedProduct;
